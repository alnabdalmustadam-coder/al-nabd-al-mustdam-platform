...
export const corporateCourses: CorporateCourse[] = [
  ...
  { id: 24, title: "موظف 2030 للتسويق الالكتروني", slug: "employee-2030-emarketing", category: "marketing", iconType: "chart" },
  ...
  { id: 69, title: "المدقق الرئيسي لإدارة الجودة أيزو 9001", slug: "iso-9001-lead-auditor", category: "management", iconType: "check" },
