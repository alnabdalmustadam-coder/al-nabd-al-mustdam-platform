  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    {
      ...
      message: 'تم إضافة "الدرس الرابع: الحوار الفعال وبناء الجسور" إلى دبلوم التسامح والمواطنة.',
      time: 'منذ 15 دقيقة',
      type: 'academic',
      isRead: false,
    },
    {
      ...
      message: 'تهانينا! تم إصدار شهادة "برنامج القيادة المستدامة والمسؤولية المجتمعية" بنجاح.',
      time: 'منذ ساعتين',
      type: 'certificate',
      isRead: false,
    },
    {
      ...
      message: 'تمت عملية إكمال الاشتراك في دبلوم التسامح والسلام بنجاح. الفاتورة رقم #INV-2026-881.',
      time: 'أمس، 04:30 م',
      type: 'billing',
      isRead: true,
    },
