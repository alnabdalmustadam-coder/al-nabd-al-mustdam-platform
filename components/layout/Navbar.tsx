...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-4 xl:px-12 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3 shrink-0">
            {session ? (
              ...
              <>
                <Link
                  href="https://members.nabdtraining.com/"
                ...
                <Button href="https://members.nabdtraining.com/" size="sm" className="hidden lg:flex text-xs xl:text-sm px-3 xl:px-4 py-1.5 xl:py-2 whitespace-nowrap">
                  سجّل الآن
                </Button>
              </>
            )}
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[60] lg:hidden transition-all duration-500 ${mobileOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
          }`}
      >
        <div
          ...
          <div className="p-6 flex flex-col gap-2 flex-1 overflow-y-auto">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-3">
              {session ? (
                ...
                <>
                  <Button href="https://members.nabdtraining.com/" variant="secondary" size="lg" className="w-full justify-center">
                    تسجيل دخول
                  </Button>
                  <Button href="https://members.nabdtraining.com/" size="lg" className="w-full justify-center">
                    سجّل الآن
                  </Button>
                </>
              )}
