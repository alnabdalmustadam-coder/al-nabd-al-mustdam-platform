        ...
        >
          <div className="mb-8">
            <span className="section-badge-glass">
              <ShieldCheck className="w-4 h-4 text-[#173A7C] ml-1 inline" />
              بيان سياسة الخصوصية والاستخدام
            </span>
          </div>
          
          <h1 className="section-main-title-premium text-3xl sm:text-4xl lg:text-[2.75rem] mb-6 leading-[1.35]">
            خصوصيتك وأمان بياناتك <br />
            <span className="gradient-text inline-block mt-3">أولويتنا القصوى</span>
          </h1>
