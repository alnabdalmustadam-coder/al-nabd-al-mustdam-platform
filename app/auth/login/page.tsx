      ...
      >
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 mx-auto mb-6 rounded-[24px] bg-[#173A7C]/5 flex items-center justify-center border border-[#173A7C]/10 shadow-sm">
             <ShieldCheck className="w-8 h-8 text-[#173A7C]" />
          </div>
          <h1 className="text-3xl font-black text-slate-900 mb-2">تسجيل الدخول</h1>
          <p className="text-base text-slate-500 font-medium">أهلاً بعودتك! أَدخِل بياناتك للمتابعة.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex items-center justify-between text-sm font-medium">
            <label className="flex items-center gap-2 text-slate-600 cursor-pointer">
              <input type="checkbox" className="rounded border-slate-300 text-[#173A7C] focus:ring-[#173A7C] w-4 h-4 cursor-pointer" />
              تذكرني
            </label>
