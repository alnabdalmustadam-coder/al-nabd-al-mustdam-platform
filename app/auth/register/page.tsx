...
export default function RegisterPage() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    if (!/^[124]\d{9}$/.test(nationalId.trim())) {
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0A1128] py-20 px-4 dir-rtl" dir="rtl">
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white font-[family-name:var(--font-cairo)]">إنشاء حساب جديد</h2>
          <p className="mt-2.5 text-sm font-medium text-slate-400">
            انضم لمنصة النبض المستدام وابدأ رحلة التعلم
          </p>
        </div>
