          ...
          <div className="space-y-3 sm:space-y-3.5">
            <div className="flex flex-col items-start">
              <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#173A7C]/10 text-[#173A7C] text-[10px] sm:text-xs font-black border border-[#173A7C]/15 shrink-0 whitespace-nowrap mb-3 sm:mb-4">
                <Headphones className="w-3.5 h-3.5 text-[#173A7C] shrink-0" />
            ...
            <div className="space-y-2 pb-1">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {ticket.status === 'open' && (
                    <span className="px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-bold bg-amber-500/10 text-amber-900 border border-amber-500/25 shrink-0 whitespace-nowrap">
                      مفتوحة 🟡
                    </span>
                  )}
                  {ticket.status === 'in_progress' && (
                    <span className="px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-bold bg-blue-500/10 text-blue-900 border border-blue-500/25 shrink-0 whitespace-nowrap">
                      جاري المعالجة 🔵
                    </span>
                  )}
                  {ticket.status === 'resolved' && (
                    <span className="px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-bold bg-emerald-500/10 text-emerald-900 border border-emerald-500/25 flex items-center gap-1 shrink-0 whitespace-nowrap">
