      ...
      <section className="relative px-4 sm:px-6 mb-16 max-w-4xl mx-auto text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 shadow-sm mb-8">
            ...
            <span className="text-xs font-extrabold text-slate-700 tracking-wide uppercase">وثيقة الشروط والأحكام</span>
          </div>
          
          <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black text-slate-900 mb-6 leading-[1.35] tracking-tight">
            الشروط والأحكام <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#173A7C] to-[#5CB07C] inline-block mt-3">الضامن لحقوق الجميع</span>
          </h1>
