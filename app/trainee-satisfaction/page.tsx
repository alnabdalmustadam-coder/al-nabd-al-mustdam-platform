...
import {
  ...
  Sparkles, ClipboardCheck, Users, Hotel, MessageSquare, Globe,
...
interface FormState {
  ...
  trainerActivities: Rating;
  trainerMotivation: Rating;
  trainerNotes: Rating;

  centerRegistration: Rating;
  centerFriendliness: Rating;
  centerResponse: Rating;
  centerOrganization: Rating;

  hotelHospitality: Rating;
  hotelLighting: Rating;
  hotelAC: Rating;
  hotelAV: Rating;
  hotelCleanliness: Rating;
...
const steps = [
  ...
  { id: 3, label: "القاعة", icon: Hotel },
  { id: 4, label: "ملاحظات", icon: MessageSquare },
];

export default function TraineeSatisfactionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ type: "satisfaction", ...form }),
      });
      ...
      {alertModal.open && (
        ...
        >
          ...
          >
            ...
            {/* Icon */}
            <div className={`w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center shadow-lg ${alertModal.type === "error"
  ...
  /* ═══ Input field helper ═══ */
  const inputClass = "w-full px-5 py-4 rounded-[20px] bg-white border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-[#173A7C] focus:ring-2 focus:ring-[#173A7C]/15 focus:bg-white outline-none transition-all duration-300 text-[15px] font-medium shadow-sm hover:border-slate-300";
        ...
        <section className="relative px-4 sm:px-6 mb-12 max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white border border-slate-200 shadow-sm mb-6">
              ...
              <span className="text-xs font-extrabold text-slate-700 tracking-wide">استبيان تقييم</span>
            </div>
            ...
            <p className="text-slate-500 text-base sm:text-lg font-medium max-w-2xl mx-auto leading-relaxed">
              رأيك يهمنا ويساعدنا على تقديم تجربة تدريبية أفضل. يرجى تخصيص بضع دقائق لتقييم البرنامج التدريبي.
            </p>
                  ...
                  {steps.map((step, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 min-w-[80px] flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2.5 px-3 sm:px-5 py-3 sm:py-3.5 rounded-[1.25rem] text-xs sm:text-sm font-bold transition-all duration-300 whitespace-nowrap ${isActive
              ...
              <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-10 relative z-10">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-400 font-medium mt-1">المدرب والمحتوى التدريبي</p>
                      </div>
                    </div>

                    <div className="relative z-10 divide-y divide-slate-100/80">
                      <RatingRow label="القدرة على إيصال الأفكار وربطها بالواقع العملي والاجتماعي" fieldName="trainerIdea" index={0} />
                      <RatingRow label="مدى ما اكتسبته من مهارات ومعلومات جديدة" fieldName="trainerSkills" index={1} />
                      <RatingRow label="تنوع التمارين والأنشطة التطبيقية" fieldName="trainerActivities" index={2} />
                      <RatingRow label="قدرة المدرب على تحفيز المشاركين وتفاعلهم" fieldName="trainerMotivation" index={3} />
                      <RatingRow label="مدى رضاك عن مذكرة البرنامج التدريبي" fieldName="trainerNotes" index={4} />
                    </div>
                  </motion.div>
                )}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-10 relative z-10">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-400 font-medium mt-1">المركز التدريبي</p>
                      </div>
                    </div>

                    <div className="relative z-10 divide-y divide-slate-100/80">
                      <RatingRow label="سرعة التسجيل واجراءات الدخول" fieldName="centerRegistration" index={0} />
                      <RatingRow label="التعامل الودود والبشاشة" fieldName="centerFriendliness" index={1} />
                ...
                {activeStep === 3 && (
                  <motion.div
                    ...
                    className="bg-white rounded-[2.5rem] p-8 sm:p-12 border border-slate-100 shadow-[0_20px_60px_-15px_rgba(23,58,124,0.08)] relative overflow-hidden"
                  >
                    <div className="absolute top-0 left-0 w-48 h-48 bg-gradient-to-br from-amber-500/[0.03] to-transparent rounded-br-full pointer-events-none" />
                    ...
                    <div className="flex items-center gap-4 mb-10 relative z-10">
                      ...
                      <div>
                        <h2 className="text-2xl font-black text-slate-900">تقييم مستوى القاعة والخدمات</h2>
                        <p className="text-sm text-slate-400 font-medium mt-1">الفندق والمرافق</p>
                      </div>
                    </div>

                    <div className="relative z-10 divide-y divide-slate-100/80">
                      <RatingRow label="مستوى الضيافة (كوفي بريك)" fieldName="hotelHospitality" index={0} />
                      <RatingRow label="الإضاءة المريحة في قاعة التدريب" fieldName="hotelLighting" index={1} />
                      <RatingRow label="كفاءة التكييف" fieldName="hotelAC" index={2} />
                      <RatingRow label="وضوح وكفاءة البرجكتور والشاشات والسمعيات" fieldName="hotelAV" index={3} />
                      <RatingRow label="مستوى النظافة بشكل عام" fieldName="hotelCleanliness" index={4} />
                    </div>
                  </motion.div>
                )}

                {/* ─── Step 4: Notes & Sources ─── */}
                {activeStep === 4 && (
                  <motion.div
                    key="step-4"
                    initial={{ opacity: 0, x: 30 }}
                    ...
                    className="bg-white rounded-[2.5rem] p-8 sm:p-12 border border-slate-100 shadow-[0_20px_60px_-15px_rgba(23,58,124,0.08)] relative overflow-hidden"
                  >
                    <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-purple-500/[0.03] to-transparent rounded-bl-full pointer-events-none" />
                    ...
                    <div className="mb-12 relative z-10">
                      <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400 font-medium mt-1">شاركنا رأيك لنتمكن من التطوير</p>
                        </div>
                      </div>
                      <textarea
                        rows={5}
                        ...
                        className="w-full px-6 py-5 rounded-[20px] bg-slate-50/50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-[#173A7C] focus:ring-2 focus:ring-[#173A7C]/15 outline-none transition-all text-[15px] font-medium resize-none leading-relaxed shadow-sm hover:border-slate-300"
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <h2 className="text-2xl font-black text-slate-900">كيف تعرفت على الدورة؟</h2>
                          <p className="text-sm text-slate-400 font-medium mt-1">اختر مصدر معرفتك بالدورة</p>
                        </div>
                      </div>
                    ...
                    {/* Terms & Conditions */}
                    <div className="flex items-start gap-3 py-4 px-1 justify-end mt-4">
              ...
              >
                ...
                {activeStep < steps.length - 1 ? (
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="px-10 shadow-xl shadow-[#173A7C]/20 group"
